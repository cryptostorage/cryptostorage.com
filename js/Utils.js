...
let GenUtils = {
	 ...
	 */
	isObject: function(arg, constructorName) {
		if (!arg) return false;
	 ...
	 */
	assertUndefined: function(arg, msg) {
	 ...
	 */
	assertUninitialized: function(arg, msg) {
	 ...
	 */
	assertEquals: function(arg1, arg2, msg) {
	 ...
	 */
	assertNotEquals: function(arg1, arg2, msg) {
	 ...
	 */
	assertObject: function(arg, name, msg) {
	 ...
	 */
	getPowerSetOfLength: function(arr, size) {
	 ...
	 */
	getCombinations: function(arr, combination_size) {
		var combinations = [];
	 ...
	 */
	getDownloadableA: function(name, contents) {
	 ...
	 */
	countNonWhitespaceCharacters: function(str) {
		let count = 0;
