...
function FaqController(div) {
	...
	this.render = function(onDone) {
		...
		LOADER.load(AppUtils.getFaqDependencies(), function(err) {
			...
			var qaControllers = [];
			qaControllers.push(new QuestionAnswerController($("<div>").appendTo(pageDiv), "What is cryptostorage.com?",
					"Cryptostorage.com is an open source application to generate public/private key pairs for multiple cryptocurrencies.  This site runs only in your device's browser."));
			qaControllers.push(new QuestionAnswerController($("<div>").appendTo(pageDiv), "What is a public/private key pair?",
					"A public/private key pair is a public address and a private key.  For example:<br>" +
...
//			if (onDone) onDone(div);
	...
	function QuestionAnswerController(div, question, answer) {
		...
		this.render = function(onDone) {
			...
			// div setup
			div.empty();
			div.addClass("flex_horizontal flex_justify_start flex_align_start");
			
			// arrow div
			arrowDiv = $("<div>").appendTo(div);
			arrowDiv.append("▶");
			...
			// question div
			var questionDiv = $("<div>").appendTo(qaDiv);
			questionDiv.append(question);
			questionDiv.click(function() { toggle(); });
			
			// answer div
			answerDiv = $("<div>").appendTo(qaDiv);
			answerDiv.hide();
