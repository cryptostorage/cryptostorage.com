(function (factory) {
    ...
    var ddslickCSS = "<style id='css-ddslick' type='text/css'>" +
        ...
        ".dd-selected{ overflow:hidden; display: flex; display: -o-flex; display: -moz-flex; display: -ms-flexbox; display: -webkit-flex; align-items: center; -ms-flex-align: center; -webkit-align-items: center; padding:10px; line-height:35px; }" +
        ...
        ".dd-option{ padding:10px; display: flex; display: -o-flex; display: -moz-flex; display: -ms-flexbox; display: -webkit-flex; align-items: center; -ms-flex-align: center; -webkit-align-items: center; border-bottom:solid 1px #ddd; overflow:hidden; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }" +
