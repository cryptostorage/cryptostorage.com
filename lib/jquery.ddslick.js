(function (factory) {
    ...
    var ddslickCSS = "<style id='css-ddslick' type='text/css'>" +
        ...
        ".dd-selected{ border: none; overflow:hidden; display: flex; display: -o-flex; display: -moz-flex; display: -ms-flexbox; display: -webkit-flex; align-items: center; -ms-flex-align: center; -webkit-align-items: center; padding:10px; line-height:35px; }" +
