...
(function ($) {
    ...
    ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                ...
                '.dd-selected{ overflow:hidden; display:flex; align-items:center; padding:10px; line-height:40px; }' +
                ...
                '.dd-option-image, .dd-selected-image { vertical-align:middle; float:left; margin-right:10px; max-width:40px;}' +
