(function (factory) {
    ...
    var ddslickCSS = "<style id='css-ddslick' type='text/css'>" +
        ".dd-select{ border: 2.25px solid; position:relative; cursor:pointer;}" +
        ...
        ".dd-options{ border: 2.25px solid; border-top:none; list-style:none; display:none; position:absolute; z-index:2000; margin:0; padding:0;background:#fff; overflow:auto;}" +
        ".dd-option { padding:10px; display: flex; display: -o-flex; display: -moz-flex; display: -ms-flexbox; display: -webkit-flex; align-items: center; -ms-flex-align: center; -webkit-align-items: center; border-bottom: 2.25px solid; overflow:hidden; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; }" +
