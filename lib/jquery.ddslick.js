...
(function ($) {
    ...
    ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                ...
                '.dd-selected{ overflow:hidden; display:flex; align-items:center; padding:10px; line-height:35px; }' +
                ...
                '.dd-option-text:hover{ cursor:pointer; }' +
                '.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }' +
                '.dd-option-selected { background:#f6f6f6; }' +
                '.dd-option-image, .dd-selected-image { vertical-align:middle; float:left; margin-right:10px; max-width:35px;}' +
    ...
    methods.init = function (userOptions) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                var original = obj, placeholder = $('<div>').attr('id', obj.attr('id') + '-dd-placeholder'); // modified per https://github.com/prashantchaudhary/ddslick/pull/83/files
