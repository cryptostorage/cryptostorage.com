        ...
        if (showPrevious || showPageNumbers || showNext) {
          ...
          if (showPrevious) {
            if (currentPage === 1) {
              ...
              html += '<li class="' + classPrefix + '-prev J-paginationjs-previous ' + disabled + '" data-num="' + (currentPage - 1) + '" title="Previous page"><a ' + (disabled ? '>' : 'href="' + pageLink + '">') + prevText + '<\/a><\/li>';
            }
          }
          ...
          if (showPageNumbers) {
            if (rangeStart <= 3) {
              for (i = 1; i < rangeStart; i++) {
                if (i == currentPage) {
                  ...
                  html += '<li class="' + classPrefix + '-page J-paginationjs-page ' + disabled + '" data-num="' + i + '"><a ' + (disabled ? '>' : 'href="' + pageLink + '">') + attributes.dataSource[i - 1] + '<\/a><\/li>';
                }
              }
            } else {
              if (attributes.showFirstOnEllipsisShow) {
                html += '<li class="' + classPrefix + '-page ' + classPrefix + '-first J-paginationjs-page ' + disabled + '" data-num="1"><a ' + (disabled ? '>' : 'href="' + pageLink + '">') + '1<\/a><\/li>';
              }
            ...
            if (rangeEnd >= totalPage - 2) {
              ...
              if (attributes.showLastOnEllipsisShow) {
                html += '<li class="' + classPrefix + '-page ' + classPrefix + '-last J-paginationjs-page ' + disabled + '" data-num="' + totalPage + '"><a ' + (disabled ? '>' : 'href="' + pageLink + '">') + attributes.dataSource[attributes.dataSource.length - 1] + '<\/a><\/li>';
              }
            }
          }
          ...
          if (showNext) {
            if (currentPage == totalPage) {
              ...
              html += '<li class="' + classPrefix + '-next J-paginationjs-next ' + disabled + '" data-num="' + (currentPage + 1) + '" title="Next page"><a ' + (disabled ? '>' : 'href="' + pageLink + '">') + nextText + '<\/a><\/li>';
            }
          }
          html += '<\/ul><\/div>';
        }
