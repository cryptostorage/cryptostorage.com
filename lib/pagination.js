          ...
          if (showPageNumbers) {
            if (rangeStart <= 3) {
              for (i = 1; i < rangeStart; i++) {
                if (i == currentPage) {
                  html += '<li class="' + classPrefix + '-page J-paginationjs-page ' + activeClassName + '" data-num="' + i + '"><a>' + attributes.dataSource[i - 1] + '<\/a><\/li>';
                } else {
                  html += '<li class="' + classPrefix + '-page J-paginationjs-page" data-num="' + i + '"><a href="' + pageLink + '">' + attributes.dataSource[i - 1] + '<\/a><\/li>';
                }
              }
            } else {
            ...
            if (rangeEnd >= totalPage - 2) {
              ...
              if (attributes.showLastOnEllipsisShow) {
                html += '<li class="' + classPrefix + '-page ' + classPrefix + '-last J-paginationjs-page" data-num="' + totalPage + '"><a href="' + pageLink + '">' + attributes.dataSource[attributes.dataSource.length - 1] + '<\/a><\/li>';
              }
            }
          }
